...
## [Recent work on LLMs]
- ``ICML 2025`` [Handling Imbalanced Pseudolabels for Vision-Language Models with Concept Alignment and Confusion-Aware Calibrated Margin](https://openreview.net/forum?id=QIL44dSUPo), Yuchen Wang, **Xuefeng Bai**<sup>✉</sup>, Xiucheng Li, Weili Guan, Liqiang Nie and Xinyang Chen<sup>✉</sup>. [[code](to-be-public)]
- ``IJCAI 2025`` [A Survey on the Feedback Mechanism of LLM-based AI Agents](to-be-public), Zhipeng Liu, **Xuefeng Bai**<sup>✉</sup>, Kehai Chen, Xinyang Chen, Xiucheng Li, Yang Xiang, Jin Liu, Hong-Dong Li, Yaowei Wang, Liqiang Nie and Min Zhang. [[code](to-be-public)]
- ``ACL 2025`` [Representation-based Reward Modeling for Efficient Safety Alignment of Large Language Model](https://openreview.net/forum?id=QIL44dSUPo), Qiyuan Deng, **Xuefeng Bai**<sup>✉</sup>, Kehai Chen, Yaowei Wang, Liqiang Nie, Min Zhang. [[code](to-be-public)]
- ``ACL 2025`` [Benchmarking and Improving Large Vision-Language Models for Fundamental Visual Graph Understanding and Reasoning](https://openreview.net/forum?id=gAN69z9vQ9), Yingjie Zhu, **Xuefeng Bai**<sup>✉</sup>, Kehai Chen, Yang Xiang, Jun Yu, Min Zhang [[code](to-be-public)]
- ``ACL 2025`` [Make Imagination Clearer! Stable Diffusion-based Visual Imagination for Multimodal Machine Translation](https://openreview.net/forum?id=xdS2fZLkkk), Andong Chen, Song Yuchen, Kehai Chen, **Xuefeng Bai**, Muyun Yang, Liqiang Nie, Jie Liu, Tiejun Zhao, Min zhang. [[code](to-be-public)]
...
- ``ACL 2025 (Findings)`` [LinguaLIFT: An Effective Two-stage Instruction Tuning Framework for Low-Resource Language Tasks](https://openreview.net/forum?id=PpTMUOxZcs), Hongbin Zhang, Kehai Chen, **Xuefeng Bai**, Yang Xiang, Min Zhang. [[code](to-be-public)]
- ``ACL 2025 (Findings)`` [LLM-based Translation Inference with Iterative Bilingual Understanding](https://openreview.net/forum?id=BLIqvJcNc6), Andong Chen, Kehai Chen, Yang Xiang, **Xuefeng Bai**, Muyun Yang, Yang Feng, Tiejun Zhao, Min zhang. [[code](to-be-public)]
